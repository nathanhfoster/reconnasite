  ...
  <Container className="PrivacyPolicy Container">
    <Row>
      <Col xs={12}>
        ...
        <p>
          eScreenLogic ("us", "we", or "our") operates the
        ...
        <p>
          ...
          our Terms and Conditions, accessible from https://astraltree.com/
        </p>
        ...
        <h4 className="headerBanner">Personal Data</h4>
        ...
        <h4 className="headerBanner">Usage Data</h4>
        ...
        <h4 className="headerBanner">Tracking & Cookies Data</h4>
        <p>
        ...
        <p>eScreenLogic uses the collected data for various purposes:</p>
        <ul>
        ...
        <h2 className="headerBanner">Transfer Of Data</h2>
        <p>
        ...
        <p>
          eScreenLogic will take all steps reasonably necessary to ensure that
        ...
        <h2 className="headerBanner">Disclosure Of Data</h2>

        <h3>Legal Requirements</h3>
        <p>
          eScreenLogic may disclose your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of eScreenLogic</li>
          <li>
        ...
        <h2 className="headerBanner">Security Of Data</h2>
        <p>
        ...
        <h2 className="headerBanner">Service Providers</h2>
        <p>
        ...
        <h2 className="headerBanner">Links To Other Sites</h2>
        <p>
        ...
        <h2 className="headerBanner">Children's Privacy</h2>
        <p>
        ...
        <h2 className="headerBanner">Changes To This Privacy Policy</h2>
        <p>
        ...
        <h2 className="headerBanner">Contact Us</h2>
        <p>
        ...
        <ul>
          <li>
            By visiting this page on our website: https://Labyrinths and
            Leviathans.com/
          </li>
        </ul>
      </Col>
